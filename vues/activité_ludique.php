 ...
 <img id="imageduhaut" src="imagehaut.jpg"></img>
    <h1>
        ...
        <h2>
          ...
          <div class="type1">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel minus incidunt, quis quas quidem sapiente unde voluptate quaerat odio totam eveniet esse, pariatur est vero rem aliquid! Molestias, expedita
          </p>
          </div>
          <br>
          <div class="type2">
          ...
          <div class="vid1">
            <video id="vid" src="vid01.mp4" controls controlsList="nodownload nofullscreen noremoteplayback" loop muted height="300"></video>  
          </div>
          <br>
    </section>
